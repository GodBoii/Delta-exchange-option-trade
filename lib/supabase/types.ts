...
export type SavedStrategyRow = { id: string; user_id: string; name: string; definition_json: Json; source_run_id: string | null; version: number; enabled_for_ai: boolean; created_at: string; updated_at: string };
