 ...
 * single-import change at each call site and no JSX moves. Each alias points
 * at the glyph that means the same thing: history is a clock running back,
 * the agent is a robot, "follow the system" is a monitor, and running an
 * analysis is a play button. Capital uses a vault rather than a wallet, which
 * reads as a consumer payment app.
 */
...
export const Play = PlayGlyph as Icon;
...
export const ThemeSystem = Monitor as Icon;
