...
COMPOSIO_TOOLS_BASE_URL = os.getenv("COMPOSIO_TOOLS_BASE_URL") or "https://backend.composio.dev/api/v3.1"
...
COMPOSIO_FACEBOOK_AUTH_CONFIG_ID = os.getenv("COMPOSIO_FACEBOOK_AUTH_CONFIG_ID")
COMPOSIO_INSTAGRAM_AUTH_CONFIG_ID = os.getenv("COMPOSIO_INSTAGRAM_AUTH_CONFIG_ID")
COMPOSIO_YOUTUBE_AUTH_CONFIG_ID = os.getenv("COMPOSIO_YOUTUBE_AUTH_CONFIG_ID")
...
COMPOSIO_ENABLE_FACEBOOK = os.getenv("COMPOSIO_ENABLE_FACEBOOK", "false").lower() == "true"
COMPOSIO_ENABLE_INSTAGRAM = os.getenv("COMPOSIO_ENABLE_INSTAGRAM", "false").lower() == "true"
COMPOSIO_ENABLE_YOUTUBE = os.getenv("COMPOSIO_ENABLE_YOUTUBE", "false").lower() == "true"
